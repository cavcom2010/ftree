...
DOMAIN="${DOMAIN:-ftree.calvinmazhindu.dev}"
BASE_URL="${BASE_URL:-https://$DOMAIN}"

GUNICORN_SERVICE="${GUNICORN_SERVICE:-ftree-gunicorn.service}"
...
Environment:
  ...
  DOMAIN=ftree.calvinmazhindu.dev
  BASE_URL=https://ftree.calvinmazhindu.dev
  GUNICORN_SERVICE=ftree-gunicorn.service
